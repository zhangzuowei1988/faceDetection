...
@interface CalculateImageSimilarity()
...
@implementation CalculateImageSimilarity
- (instancetype)init
{
    self = [super init];
    if (self) {
...
{
    CalculateImageSimilarity * getSimilarity = [[CalculateImageSimilarity alloc]init];
